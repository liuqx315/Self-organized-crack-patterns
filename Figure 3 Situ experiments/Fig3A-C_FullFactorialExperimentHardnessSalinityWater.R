...
p2
ggsave(p2,filename = "p1Hardness.pdf",width = 5,height = 4, dpi = 3000)

# ==================Draw the summary table of Hardness============== 
#::::::::::::::::::::::::::::::::::::::
# Compute descriptive statistics by groups
stable <- desc_statby(CrackPlant, measure.var = "Hardness",
...
dataHard <- data.frame(matrix(nrow=48,ncol=0))
...
dataHard$Group<- unlist(CrackPlant$Group)
...
p3
ggsave(p3,filename = "p2Salinity.pdf",width = 5,height = 4, dpi = 3000)
...
# ==================Draw the summary table of Salinity============== 
#::::::::::::::::::::::::::::::::::::::
# Compute descriptive statistics by groups
stable <- desc_statby(CrackPlant, measure.var = "Salinity",
                      grps = "Treatments")
#stable <- stable[, c("Treatments", "length", "mean", "sd")]
stable
# Summary table plot, medium orange theme
...
p4
ggsave(p4,filename = "p3Water_content.pdf",width = 5,height = 4, dpi = 3000)
...
# ==================Draw the summary table of Water_content============== 
#::::::::::::::::::::::::::::::::::::::
# Compute descriptive statistics by groups
stable <- desc_statby(CrackPlant, measure.var = "water",
                      grps = "Treatments")
#stable <- stable[, c("Treatments", "length", "mean", "sd")]
stable
# Summary table plot, medium orange theme
...
p5
#ggsave(p5,filename = "S3p1Crack_width.pdf",width = 5,height = 4, dpi = 3000)

res.aov4 <- aov(Crack_width ~ Treatments, data = CrackPlant)
summary.lm(res.aov4)
summary(res.aov4)
TukeyHSD(res.aov4)

# ==================Draw the summary table of Crack_width============== 
#::::::::::::::::::::::::::::::::::::::
# Compute descriptive statistics by groups
stable <- desc_statby(CrackPlant, measure.var = "Crack_width",
                      grps = "Treatments")
#stable <- stable[, c("Treatments", "length", "mean", "sd")]
stable
# Summary table plot, medium orange theme
