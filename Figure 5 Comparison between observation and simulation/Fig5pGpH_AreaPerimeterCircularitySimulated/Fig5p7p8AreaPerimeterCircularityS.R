...
p <- ggplot(CrackPlant, aes(x=Area, y=Perimeter, alpha=1,color=Circularity)) +
  ...
  annotate("text", x=0.3, y=5, label=TeX("$y = 4.1x^{0.53}$", output="character"),####################
...
p1
ggsave(p1,filename = "p7AreaPerimeterS.pdf",width = 5,height = 5)
...
pp1
ggsave(pp1,filename = "p8AreCircularityS.pdf",width = 5,height = 5)
