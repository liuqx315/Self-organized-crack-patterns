...
plot(plant111,'r--','linewidth',2); hold on;
...
set(gca,'ytick',[0.2:0.05:0.36],'linewidth',2,'fontsize',FS,'ticklength',[0.020 0.015],'xminortick','off','yminortick','off');
xlabel('Time after disturbance, $t$','fontsize',FS,'Interpreter','latex')
ylabel('Post-disturbance recovery, $\langle \mathcal{P}\rangle$','fontsize',FS,'Interpreter','latex')
ytickformat('%1.2f')
xlim([0 80])
ylim([0.19 0.36])
legend('Patterns intact','Homogeneity','Patterns intact2','Homogenized2','Patterns intact3','Homogenized3','box','off')
% yticks(0:0.1:0.4);
save2pdf('Fig6pE_MeanBiomass')